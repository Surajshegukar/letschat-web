...
const env: Env = {
  ...
  GOOGLE_CLIENT_SECRET: process.env.GOOGLE_CLIENT_SECRET || "google_client_secret_placeholder",
  GITHUB_CLIENT_ID: process.env.GITHUB_CLIENT_ID || "github_client_id_placeholder",
  GITHUB_CLIENT_SECRET: process.env.GITHUB_CLIENT_SECRET || "github_client_secret_placeholder",
...
if (env.NODE_ENV === "production") {
  ...
  const requiredInProduction = [
    ...
    { key: "RESEND_API_KEY", placeholder: "re_dev_placeholder" },
    { key: "GOOGLE_CLIENT_ID", placeholder: "google_client_id_placeholder" },
    { key: "GOOGLE_CLIENT_SECRET", placeholder: "google_client_secret_placeholder" },
    { key: "GITHUB_CLIENT_ID", placeholder: "github_client_id_placeholder" },
    { key: "GITHUB_CLIENT_SECRET", placeholder: "github_client_secret_placeholder" },
  ] as const;
